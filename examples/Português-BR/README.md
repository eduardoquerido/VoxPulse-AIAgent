# 🗳️ VoxPulse-AI: Análise de Sentimento Político Multi-Agente

## ✨ Visão Geral

O VoxPulse-AI simula uma equipe de especialistas digitais, composta por um **Pesquisador de Dados Políticos** e um **Analista de Sentimento Político**. Juntos, eles vasculham a web em busca de notícias e artigos sobre os políticos selecionados, processam as informações e geram relatórios detalhados, incluindo métricas estruturadas para comparação visual.


## 🚀 Demonstração Visual

Veja o VoxPulse-AI em ação, fornecendo insights sobre a percepção pública de diferentes figuras políticas.

### 1. Pesquisa e Relatório Executivo
...
### 4. Perfil Multidimensional (Gráfico Radar)
...
---
**VoxPulse-AI** - Desenvolvido para o portfólio de análise eleitoral 2026.